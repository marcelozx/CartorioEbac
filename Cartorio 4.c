...
#include <stdlib.h> //biblioteca de alocação de espaço em memóriq
#include <locale.h> //biblioteca de alocaçópes de texto por região
...
int main()
   {
	...
	for(laco=1;laco=1;)
    {
     ...
     scanf("%d", &opcao); // Aarmazenando a escolha do usuario	
